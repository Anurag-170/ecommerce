...
let dis; // Declare variable outside of the function

const fetchData = async () => {
  try {
    const response = await axios.get('http://localhost/php/API/?key=discount');
    dis = response.data; // Assign response data to the variable
  } catch (error) {
...
// Call the fetchData function somewhere in your code to populate responseData
fetchData()
  .then(() => {
    // You can access responseData here or anywhere else in your code
  ...
  export { dis };
  let products; // Declare variable outside of the function

const fetchData1 = async () => {
  try {
    const response = await axios.get('http://localhost/php/API/?key=product');
    products = response.data; // Assign response data to the variable
  } catch (error) {
    console.error('Error fetching data:', error);
    throw error;
  }
