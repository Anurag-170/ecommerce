...
if(authToken!== null)
{
  ...
  id=a[0];
	...
	function getWishs1() {
  axios.get('http://localhost/php/API/?key=orders_cancel&cid='+id).then(function(response) {
      console.log(response.data);
      setWishs1(response.data);
  });
}
 const handelcancel = (i) => {
    axios.post('http://localhost/php/API/?key=cancelorder&id='+i).then(function(response){
      toast.success("Cancel successfully & if you have paid online your refund will be initiated in next 24 hours");
