    ...
    const handleSubmit = (event) => {
        ...
        try {
          ...
          if (!credentials.email && !credentials.password) {
            ...
            axios.post('http://localhost/php/API/?key=GET', inputs).then(function(response){
 if (response.data!='') { 
...
<div className="login-container">
      <div className="login-content">
        ...
        <div className="login-form-container">
          ...
          <center>
        <Link to="/reg">  <button className="create-account-button">Create your Multimart account</button></Link>
          </center>
        </div>
      </div>
    </div>
